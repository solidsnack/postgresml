...
impl std::str::FromStr for Algorithm {
    ...
    fn from_str(input: &str) -> Result<Algorithm, Self::Err> {
        match input {
            ...
            "bernoulli_naive_bayes" => Ok(Algorithm::bernoulli_naive_bayes),
            "categorical_naive_bayes" => Ok(Algorithm::categorical_naive_bayes),
            "multinomial_naive_bayes" => Ok(Algorithm::multinomial_naive_bayes),
            "gaussian_naive_bayes" => Ok(Algorithm::gaussian_naive_bayes),
            _ => Err(()),
        }
    }
}
...
impl std::string::ToString for Algorithm {
    fn to_string(&self) -> String {
        match *self {
            ...
            Algorithm::bernoulli_naive_bayes => "bernoulli_naive_bayes".to_string(),
            Algorithm::categorical_naive_bayes => "categorical_naive_bayes".to_string(),
            Algorithm::multinomial_naive_bayes => "multinomial_naive_bayes".to_string(),
            Algorithm::gaussian_naive_bayes => "gaussian_naive_bayes".to_string(),
        }
    }
}
